...
// PHONG PIXEL SHADER
VertexOutput PhongVertexShaderFunction(VertexInput input)
{
	VertexOutput output;
...
float4 PhongPixelShaderFunction(VertexOutput input) : COLOR0
{
...
// RED
RGB_OUTPUT RedVSMain(RGB_INPUT input)
{
    RGB_OUTPUT output;
...
float4 RedPSMain(RGB_OUTPUT input) : SV_Target
{
...
technique RedValue
{
    pass pass1
    {
        VertexShader = compile vs_4_0 RedVSMain();
        PixelShader = compile ps_4_0 RedPSMain();
    }
}


// GREEN 
RGB_OUTPUT GreenVSMain(RGB_INPUT input)
{
    RGB_OUTPUT output;
...
float4 GreenPSMain(RGB_OUTPUT input) : SV_Target
{
    return float4(0, input.Color.g, 0, 1); // output only the red component of the color
}
technique GreenValue
{
    pass pass1
    {
        VertexShader = compile vs_4_0 GreenVSMain();
        PixelShader = compile ps_4_0 GreenPSMain();
    }
}

// BLUE 
RGB_OUTPUT BlueVSMain(RGB_INPUT input)
{
    RGB_OUTPUT output;
...
float4 BluePSMain(RGB_OUTPUT input) : SV_Target
{
...
technique BlueValue
{
    pass pass1
    {
        VertexShader = compile vs_4_0 BlueVSMain();
        PixelShader = compile ps_4_0 BluePSMain();
    }
}

// RGB 
RGB_OUTPUT RGBVSMain(RGB_INPUT input)
{
    RGB_OUTPUT output;
...
technique RGBValue
{
    pass pass1
    {
        VertexShader = compile vs_4_0 RGBVSMain();
        PixelShader = compile ps_4_0 RGBPSMain();
    }
}
